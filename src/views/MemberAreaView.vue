          ...
          <div>
            <ul class="menu menu-vertical rounded-box">
              <li class="mb-4 text-black">
                <a href="#log-absences" class="block py-2 px-4 rounded hover:bg-[#c4a000] hover:text-white hover:font-semibold">Log Absences</a>
              </li>
              <li class="mb-4 text-black">
                <a href="#apply-promotion" class="block py-2 px-4 rounded hover:bg-[#c4a000] hover:text-white hover:font-semibold">Apply for Promotion</a>
              </li>
              <li class="mb-4 text-black">
                <a href="#download-resources" class="block py-2 px-4 rounded hover:bg-[#c4a000] hover:text-white hover:font-semibold">Download Resources</a>
              </li>
              <li class="mb-4 text-black">
                <a href="#help" class="block py-2 px-4 rounded hover:bg-[#c4a000] hover:text-white hover:font-semibold">Help</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <section class="bg-white shadow-md rounded-lg w-full" id="apply-promotion">
          <div class="p-2 flex flex-wrap">
            ...
            <div v-if="promotionsActive" class="p-2">
              ...
              <PromotionComponent />
              <div class="flex">
                <p>Application Form</p><DownloadComponent />
              </div>
            </div>
