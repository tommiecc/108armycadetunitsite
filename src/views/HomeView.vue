      ...
      <div class="card bg-base-100 image-full w-72 min-h-80 max-h shadow-xl hover:scale-105">
        ...
        <div class="card-body bg-black bg-opacity-40 rounded-2xl">
          ...
          <label class="input input-bordered flex items-center gap-2">
            ...
            <input type="password" class="grow max-w-32"/>
          </label>
          <div class="card-actions justify-end">
            <button class="text-white bg-[#1a3409] p-4 rounded-lg hover:bg-[#c4a000] hover:border-[#c4a000] hover:scale-105 transition-all">Log In</button>
          </div>
        </div>
      </div>
    </div>
    <div>
      <div class="card bg-base-100 image-full w-72 min-h-80 shadow-xl hover:scale-105">
        ...
        <div class="card-body bg-black bg-opacity-40 rounded-2xl">
          ...
          <div class="card-actions justify-end">
            <a href="/about" class="text-white bg-[#1a3409] p-4 rounded-lg hover:bg-[#c4a000] hover:border-[#c4a000] hover:scale-105 transition-all">Log an absence</a>
          </div>
        </div>
      </div>
    </div>
    <div>
      <div class="card bg-base-100 image-full w-72 min-h-80 shadow-xl hover:scale-105">
        ...
        <div class="card-body bg-black bg-opacity-40 rounded-2xl">
          ...
          <div class="card-actions justify-end">
            <a href="https://www.armycadets.gov.au/find-a-unit/unit?ua=108ACU" target="_blank" class="text-white bg-[#1a3409] p-4 rounded-lg hover:bg-[#c4a000] hover:border-[#c4a000] hover:scale-105 transition-all">Go</a>
          </div>
        </div>
      </div>
    </div>
