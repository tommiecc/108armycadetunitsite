  ...
  data() {
    return {
      ...
      steps: [
        ...
        {
          title: 'Endorsement',
          content: 'Send your application to an NCO to endorse your application. The NCO will forward your application to the senior leadership group.'
        },
        {
          title: 'Interview',
        ...
        {
          title: 'Decision',
          content: 'You will be notified of the outcome of your application. You may be required to attend a Leadership And Instruction Course before you are promoted.'
        }
      ]
    }
  },
